...
public class ImagePanel extends JPanel {
    ...
    public  BufferedImage imageselect;
                ...
                if(endDrag!=null && startDrag!=null) {
                    try {
                        shape = makeRectangle(startDrag.x, startDrag.y, e.getX(),
                                e.getY());
                        imageselect=image.getSubimage(startDrag.x, startDrag.y, e.getX()-startDrag.x, e.getY()-startDrag.y);
                        mf.selectImage=imageselect;
                        mf.updateSelectedRegion(imageselect);   
                        startDrag = null;
                        endDrag = null;
                        repaint();
                    } catch (Exception e1) {
